...
Pod::Spec.new do |s|
  s.name             = 'HoloTargetProtocolPool'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HoloTargetProtocolPool.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/gonghonglou/HoloTargetProtocolPool'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gonghonglou' => 'gonghonglou@icloud.com' }
  s.source           = { :git => 'https://github.com/gonghonglou/HoloTargetProtocolPool.git', :tag => s.version.to_s }
